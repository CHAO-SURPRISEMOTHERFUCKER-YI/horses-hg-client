export default function Privacy() {
  return (
    <>
      ...
      <ul>
        <li>
          Información que usted proporciona al completar formularios en nuestro
          sitio web.
        </li>
        <li>
          Detalles de sus visitas a nuestro sitio web, incluidos los datos de
          tráfico, los datos de localización y otros datos de comunicación.
        </li>
        <li>
          Información que usted proporciona cuando se comunica con nosotros por
          cualquier motivo.
        </li>
      </ul>
      ...
      <ul>
        <li>
          Para proporcionarle la información, productos y servicios que nos
          solicita.
        </li>
        <li>
          Para asegurarnos de que el contenido de nuestro sitio se presenta de
          la manera más efectiva para usted y su dispositivo.
        </li>
        <li>
          Para cumplir con nuestras obligaciones derivadas de cualquier contrato
          celebrado entre usted y nosotros.
        </li>
      ...
      <ul>
        <li>
          Si tenemos la obligación de divulgar o compartir su información
          personal para cumplir con cualquier obligación legal.
        </li>
        <li>
          Para proteger los derechos, la propiedad o la seguridad de [Nombre de
          la Empresa/Organización], nuestros clientes u otros.
        </li>
      </ul>
      ...
      <p>
        ...
        ser procesada por personal que opera fuera del EEE y que trabaja para
        nosotros o para uno de nuestros proveedores. Al enviar su información
        personal, usted acepta esta transferencia, almacenamiento o
        procesamiento.
      </p>
      ...
      <p>
        ...
        dicho procesamiento marcando ciertas casillas en los formularios que
        utilizamos para recopilar sus datos. También puede ejercer el derecho en
      ...
      <p>
        ...
        para ver cualquier actualización o cambio en nuestra política de
        privacidad.
      </p>
